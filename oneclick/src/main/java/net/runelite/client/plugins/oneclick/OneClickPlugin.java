...
{
	private static final Logger logger = LoggerFactory.getLogger(OneClickPlugin.class);

	public OneClickPlugin(PluginWrapper wrapper)
	{
		super(wrapper);
	}
	...
	public void start()
	{
		logger.info("OneClickPlugin external plugin started");
	}

	@Override
	public void stop()
	{
		logger.info("OneClickPlugin external plugin stopped");
	}
	...
	public static class OneClickPluginOprs extends net.runelite.client.plugins.Plugin
	{
