...
{
	private static final Logger logger = LoggerFactory.getLogger(net.runelite.client.plugins.tickeater.TickEater.class);

	public TickEater(PluginWrapper wrapper)
	{
		super(wrapper);
	}
	...
	public void start()
	{
		logger.info("TickEater external plugin started");
	}

	@Override
	public void stop()
	{
		logger.info("TickEater external plugin stopped");
	}
	...
	public static class TickEaterOprs extends net.runelite.client.plugins.Plugin
	{
		@Inject
