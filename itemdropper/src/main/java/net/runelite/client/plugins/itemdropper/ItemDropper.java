...
{
	private static final Logger logger = LoggerFactory.getLogger(net.runelite.client.plugins.itemdropper.ItemDropper.class);

	public ItemDropper(PluginWrapper wrapper)
	{
		super(wrapper);
	}
	...
	public void start()
	{
		logger.info("ItemDropper external plugin started");
	}

	@Override
	public void stop()
	{
		logger.info("ItemDropper external plugin stopped");
	}
	...
	public static class ItemDropperOprs extends net.runelite.client.plugins.Plugin
	{
		@Inject
