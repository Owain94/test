...
{
	private static final Logger logger = LoggerFactory.getLogger(GearSwapper.class);

	public GearSwapper(PluginWrapper wrapper)
	{
		super(wrapper);
	}
	...
	public void start()
	{
		logger.info("GearSwapper external plugin started");
	}

	@Override
	public void stop()
	{
		logger.info("GearSwapper external plugin stopped");
	}
	...
	public static class GearSwapperOprs extends net.runelite.client.plugins.Plugin
	{
		@Inject
