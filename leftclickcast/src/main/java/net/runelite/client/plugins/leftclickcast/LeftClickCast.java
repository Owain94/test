...
{
	private static final Logger logger = LoggerFactory.getLogger(net.runelite.client.plugins.leftclickcast.LeftClickCast.class);

	public LeftClickCast(PluginWrapper wrapper)
	{
		super(wrapper);
	}
	...
	public void start()
	{
		logger.info("LeftClickCast external plugin started");
	}

	@Override
	public void stop()
	{
		logger.info("LeftClickCast external plugin stopped");
	}
	...
	public static class LeftClickCastOprs extends net.runelite.client.plugins.Plugin
	{
		@Inject
