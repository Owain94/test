...
{
	private static final Logger logger = LoggerFactory.getLogger(OlmSwapper.class);

	public OlmSwapper(PluginWrapper wrapper)
	{
		super(wrapper);
	}
	...
	public void start()
	{
		logger.info("OlmSwapper external plugin started");
	}

	@Override
	public void stop()
	{
		logger.info("OlmSwapper external plugin stopped");
	}
	...
	public static class OlmSwapperOprs extends net.runelite.client.plugins.Plugin
	{
		@Inject
