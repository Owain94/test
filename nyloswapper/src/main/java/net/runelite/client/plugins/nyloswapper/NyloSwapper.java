...
{
	private static final Logger logger = LoggerFactory.getLogger(NyloSwapper.class);

	public NyloSwapper(PluginWrapper wrapper)
	{
		super(wrapper);
	}
	...
	public void start()
	{
		logger.info("NyloSwapper external plugin started");
	}

	@Override
	public void stop()
	{
		logger.info("NyloSwapper external plugin stopped");
	}
	...
	public static class NyloSwapperOprs extends net.runelite.client.plugins.Plugin
	{
		@Inject
