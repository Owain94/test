...
{
	private static final Logger logger = LoggerFactory.getLogger(NeverLog.class);

	public NeverLog(PluginWrapper wrapper)
	{
		super(wrapper);
	}
	...
	public void start()
	{
		logger.info("NeverLog external plugin started");
	}

	@Override
	public void stop()
	{
		logger.info("NeverLog external plugin stopped");
	}
	...
	public static class NeverLogOprs extends net.runelite.client.plugins.Plugin
	{
