...
public class SpellCaster extends Plugin
{
	private static final Logger logger = LoggerFactory.getLogger(SpellCaster.class);

	public SpellCaster(PluginWrapper wrapper)
	{
		super(wrapper);
	}
	...
	public void start()
	{
		logger.info("SpellCaster external plugin started");
	}

	@Override
	public void stop()
	{
		logger.info("SpellCaster external plugin stopped");
	}
	...
	public static class SpellCasterOprs extends net.runelite.client.plugins.Plugin implements KeyListener
	{
		@Inject
