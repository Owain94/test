...
{
	private static final Logger logger = LoggerFactory.getLogger(PraySwap.class);

	public PraySwap(PluginWrapper wrapper)
	{
		super(wrapper);
	}
	...
	public void start()
	{
		logger.info("PraySwap external plugin started");
	}

	@Override
	public void stop()
	{
		logger.info("PraySwap external plugin stopped");
	}
	...
	public static class PraySwapOprs extends net.runelite.client.plugins.Plugin
	{
		@Inject
